...
finalResultRoot = '\\CGM10\D\Video_Saliency_Results\FinalResults2\PCA_Fusion_v0Ran\';
...
%         end
        ...
        try
            ...
            for ifr = 1:length(indFr)
                ...
                predMaps(:,:,ifr)=PCA_Fused_Saliency_v2(fr.ofx,fr.ofy,fr.image);
