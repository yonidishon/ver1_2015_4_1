function objHeatMap = computeObjectnessHeatMap_modified(img,windows)
% Modified: Yonatan Dishon 31/12/2014
%           output is change to probability map
