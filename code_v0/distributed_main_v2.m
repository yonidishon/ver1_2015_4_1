...
finalResultRoot = '\\CGM10\D\Video_Saliency_Results\FinalResults2\PCA_Fusion_v1slic\';
...
lockFileFolder='\\CGM10\Users\ydishon\Documents\Video_Saliency\lockfiles\2015_02_20\';
...
%         end
        ...
        try
            ...
            for ifr = 1:length(indFr)
                ...
                [rg_S,r_S]=PCA_Saliency_Core_v2(fr.image);
                [rg_M,r_M]=PCA_Motion_Saliency_Core_v2(fr.ofx,fr.ofy,fr.image);
                valueMap=r_S.*r_M;
                ...
                [sim(:,:,ifr), outMaps] = similarityFrame3(predMaps(:,:,indFr(ifr)), gazeData, measures, ...
                    'self', ...
                    struct('method', 'saliency_PCA_r_M', 'map', r_M), ...
                    struct('method', 'saliency_PCA_r_S', 'map', r_S), ...
                    struct('method', 'saliency_PCA_rg_M', 'map', rg_M), ...
                    struct('method', 'saliency_PCA_rg_S', 'map', rg_S));
                if (saveVideo && verNum >= 2012)
