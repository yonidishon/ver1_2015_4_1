...
VISDST = fullfile(videos_fold{1},suffixfold,'post_analysis'); % TODO
...
for ii=1:size(videos,1)
    ...
    for jj=1:FRMS_CNT
        ...
        premap=insertText(im2uint8(premap),pos,'Houghforest','FontSize',8);
        postmap=insertText(postmap,pos,'Houghforest_Post','FontSize',8);
