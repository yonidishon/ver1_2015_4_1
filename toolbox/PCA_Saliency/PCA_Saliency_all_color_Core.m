function [rColor,rSpatial,rMotion] = PCA_Saliency_all_color_Core(fx,fy,I_RGB)
...
for pInd=1:numOfLevels
    [MT]  = globalDiff(a,rad,Pyramid);
    [ST1,CL]  = globalDiff1(Pyramid);
    mtDistinc(:,:,pInd) = imresize(MT,orgSize,'bicubic');
